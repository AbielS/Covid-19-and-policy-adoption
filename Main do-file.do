...
*post-hoc test: teasing out elements of the democratic structure
	*insert V-dem, ICRG, GSoD, & WB-data
	sort c_id 
	merge c_id using "/Users/ab.3116/Dropbox/covid and pol adoption/GitHub/indicators 1.dta"
	drop _merge
	sort c_id
	merge c_id using "/Users/ab.3116/Dropbox/covid and pol adoption/GitHub/indicators 2.dta"
	drop _merge
	sort c_id
	merge c_id using "/Users/ab.3116/Dropbox/covid and pol adoption/GitHub/indicators 3.dta"
	drop _merge
	*scale & label variables
	gen i_adm2=i_adm*100
	gen ri_adm2=ri_adm*100
	gen effective_parliament=e_par*100
	gen Bureaucratic_quality=b_quality*100
	gen government_effectiveness2= government_effectiveness*100
	label var i_adm2 "Impartial administration"
	label var ri_adm2 "Rigorous and impartial administration"
	label var v2exremhog "Head of gov. removal by legislature in practice"
	label var effective_parliament "Effective parliament"
	label var Bureaucratic_quality "Bureaucratic_quality"
	label var government_effectiveness2 "Government effectiveness"
